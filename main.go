...
import (
	dpfm_api_caller "data-platform-api-inspection-lot-reads-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-inspection-lot-reads-rmq-kube/config"
	"encoding/json"
	"fmt"
	"time"
